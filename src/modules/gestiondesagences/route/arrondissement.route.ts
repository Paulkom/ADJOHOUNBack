...
import { createArrondissement, deleteArrondissement, getAllArrondissement, getArrondissement, getArrondissementByCommune, getArrondissements, updateArrondissement } from '../controller/arrondissement.controller';
...
export  const arrondissementsRoutes =  (router: express.Router) => {
  ...
  router.get('/api/all/arrondissements', getArrondissements);
